...
public class EmpireStateRenderer extends EtapaRenderer implements GLSurfaceView.Renderer {
	...
	void createSquares(){	
		...
		squaresDrawables[0][7] = R.drawable.bagel_1;
		squaresDrawables[0][8] = R.drawable.bagel_1;
		
		squaresDrawables[1][6] = R.drawable.bagel_1;
		squaresDrawables[1][7] = R.drawable.bagel_1;
		squaresDrawables[1][8] = R.drawable.bagel_1;
		
		squaresDrawables[2][6] = R.drawable.bagel_1;
		squaresDrawables[2][7] = R.drawable.bagel_1;
		squaresDrawables[2][8] = R.drawable.bagel_1;
		
		squaresDrawables[3][6] = R.drawable.bagel_1;
		squaresDrawables[3][7] = R.drawable.bagel_1;
		squaresDrawables[3][8] = R.drawable.bagel_1;
		
		squaresDrawables[4][6] = R.drawable.bagel_1;
		squaresDrawables[4][7] = R.drawable.bagel_1;
		squaresDrawables[4][8] = R.drawable.bagel_1;
		
		squaresDrawables[5][6] = R.drawable.bagel_1;
		squaresDrawables[5][7] = R.drawable.bagel_1;
		squaresDrawables[5][8] = R.drawable.bagel_1;
