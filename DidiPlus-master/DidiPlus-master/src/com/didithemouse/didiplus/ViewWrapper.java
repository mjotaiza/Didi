...
public class ViewWrapper {
	...
	public ViewWrapper (double _x2, double _y2, int _xOffset2, int _yOffset2, View v, EtapaEnum _etapa)
	{
		x = _x2; y = _y2; xOffset = _xOffset2; yOffset = _yOffset2; etapa=_etapa;
		setView(v);
	}
	
	public ViewWrapper (double _x2, double _y2, int _xOffset2, int _yOffset2, int _drawableID, float _scaleFactor, EtapaEnum _etapa)
	{
		x = _x2; y = _y2; xOffset = _xOffset2; yOffset = _yOffset2; etapa=_etapa;
