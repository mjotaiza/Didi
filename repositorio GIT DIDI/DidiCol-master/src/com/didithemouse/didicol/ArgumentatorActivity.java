...
public class ArgumentatorActivity extends Activity {
	...
	public void setInstruction(){
		...
		if(currentIndex==0)
			insTextView.setText(name+": Lee el texto y analiza su ortografía.");
		else if(currentIndex==1)
			insTextView.setText(name+": Lee el texto y analiza su vocabulario.");
		else if(currentIndex==2)
			insTextView.setText(name+": Lee el texto y analiza uso de los verbos.");
