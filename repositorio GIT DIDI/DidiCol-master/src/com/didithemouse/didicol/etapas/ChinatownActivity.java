...
public class ChinatownActivity extends EtapaActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		badgeDrawable = (R.drawable.badge_statue_small);
	...
	void setObjects() {
		...
		posiciones[0] = new LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT, 935 ,  110); //prismaticos
		posiciones[1] = new LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT, 837 ,  501); //salvavidas
		...
		drawables = new int[] {R.drawable.liberty_prismaticos,
				   R.drawable.liberty_salvavidas,
